...
const REGISTERED_EXPERIMENTS = [
  ...
  // [RN] React Native-specific experiments, so RN-gated behavior can be exercised in tests.
  Root.ExperimentNames.ExperimentName.REACT_NATIVE_SPECIFIC_UI,
  Root.ExperimentNames.ExperimentName.NOT_REACT_NATIVE_SPECIFIC_UI,
  Root.ExperimentNames.ExperimentName.ENABLE_TIMELINE_FRAMES,
];
